...
exports.login = async function (req, res) {
    ...
    var fetch_pass = new Promise(function (resolve, reject) {
           multichain.listStreamKeyItems({stream: userstream, key: username, verbose: false,count : 1,start : -1
	   }, (err, tx) => {
	    console.log(tx)
            resolve(tx)
   })
    ...
    console.log(password_act,par)
     var password_actual = par.password
     console.log(username,password,password_actual)
